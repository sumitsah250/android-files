...
public class EnglishMediumScience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_medium_science);
    ...
    private void LoadData() {
        ChapterList.clear();
        firestore.collection("EnglishMediumScience").orderBy("id", Query.Direction.ASCENDING)
