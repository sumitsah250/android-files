...
public class EnglishMediumOptMath extends AppCompatActivity {
    FirebaseFirestore firestore;
    ArrayList<Model> ChapterList;
    Adapter adapter;    RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_english_medium_opt_math);
