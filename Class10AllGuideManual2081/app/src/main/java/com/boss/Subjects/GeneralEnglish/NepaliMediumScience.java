...
public class NepaliMediumScience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nepali_medium_science);
    ...
    private void LoadData() {
        ChapterList.clear();
        firestore.collection("NepaliMediumScience").orderBy("id", Query.Direction.ASCENDING)
