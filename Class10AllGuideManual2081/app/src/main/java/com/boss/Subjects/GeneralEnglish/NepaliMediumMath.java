...
public class NepaliMediumMath extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nepali_medium_math);
    ...
    private void LoadData() {
        ChapterList.clear();
        firestore.collection("NepaliMediumMath").orderBy("id", Query.Direction.ASCENDING)
