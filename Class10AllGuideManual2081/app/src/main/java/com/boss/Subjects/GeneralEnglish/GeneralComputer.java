...
public class GeneralComputer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_computer);
    ...
    private void LoadData() {
        ChapterList.clear();
        firestore.collection("GeneralComputer").orderBy("id", Query.Direction.ASCENDING)
