...
public class EnglishMediumSocial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_medium_social);
    ...
    private void LoadData() {
        ChapterList.clear();
        firestore.collection("EnglishMediumSocial").orderBy("id", Query.Direction.ASCENDING)
