...
public class NeplaiMediumSocial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neplai_medium_social);
    ...
    private void LoadData() {
        ChapterList.clear();
        firestore.collection("NepaliMediumSocial").orderBy("id", Query.Direction.ASCENDING)
