...
import com.boss.class10allguidemanual2081.databinding.ActivityGeneralEnglishBinding;
...
public class GeneralEnglish extends AppCompatActivity {
    ActivityGeneralEnglishBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityGeneralEnglishBinding.inflate(getLayoutInflater());
